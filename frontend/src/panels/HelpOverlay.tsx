  ...
  return (
    <div className="help-doc">
      ...
      <p className="help-note">
        ...
        기록해줘"(관찰 기록). 이 화면의 <strong>점 70개가 전부 이런 업무 하나씩</strong>이에요.
      </p>
      ...
      <p>
        ...
        순간 🗣 "지우 사진 좀 보여줘"가 <b>삭제로 오발</b>돼요. 70개 업무 × 수천 가지
      ...
      <table className="help-table">
        <tbody>
          ...
          <tr><td>🔴 자료 만들기</td><td>활동지 · 영상 · 슬라이드 · 게임 "만들어줘"</td></tr>
        </tbody>
      </table>
      <p>
        영역 속 <strong>점 하나 = 배우는 "의도" 하나</strong>예요. 지금은 모두 70개.
      </p>
      ...
      <p>
        ...
        <strong>전체 96% 달성(최종 목표)</strong>. 바닥 동심원이 단계마다 하나씩 켜지고,
        바깥 호가 전체 점수예요.
      </p>
    ...
    <div className="help-doc">
      ...
      <table className="help-table">
        <tbody>
          <tr>
            <td>① 시험지 만들기</td>
            <td>검수자 두 분이 <b>시험 문항</b>을 만들어요 — 상단 <b>[📝 시험지 작성]</b>{' '}
              또는 도움말 → 시험 문항 만들기. <b>위험 의도 7개부터</b> 권장</td>
          </tr>
          <tr>
            <td>② 채점 (주 1회)</td>
            <td>운영자가 <b>[🎯 채점 실행]</b> 버튼(대시보드·검수창, 비밀번호 필요)을 누르면 →{' '}
              <b>뇌가 처음으로 밝아져요</b> (지금 실력만큼)</td>
          </tr>
          <tr>
            <td>③ 가르치기 (상시)</td>
      ...
      <table className="help-table">
        <tbody>
          <tr>
            <td>웹에서 바로</td>
            <td><b>[📝 시험지 작성]</b> → 문항 작성 탭에서 질문 + 1~5점 제출 → 다른 분이{' '}
      ...
      <ul className="help-faq">
        ...
        <li>
          <b>채점은 누가 어떻게 돌리나요?</b> 운영자가 해요 — <b>📊 대시보드의 PERFORMANCE</b>{' '}
          또는 <b>📝 시험지 작성창</b>의 <b>[🎯 채점 실행]</b> 버튼을 누르고{' '}
          <b>운영자 비밀번호</b>를 입력하면 몇 분 뒤 점수가 반영돼요(명령어{' '}
          <code>scripts/run_arena.py --commit</code>로도 가능). 주기는 <b>주 1회</b> 권장,
          문항을 새로 채운 뒤에도 한 번씩.
        </li>
        ...
        <li><b>3D가 느려요.</b> 하단 [📊 대시보드]로 전환하세요 — 같은 데이터를 표·그래프로 봅니다.</li>
      </ul>
    ...
    <div className="help-doc">
      ...
      <table className="help-table">
        <tbody>
          <tr>
            <td>웹에서 바로</td>
            <td>상단 <b>[📝 시험지 작성]</b> — 자리에서 몇 문항씩. 질문+1~5점 제출 →
      ...
      <p className="help-note">
        ...
        공부(강화하기·즉석 문답)를 시킨 뒤 <b>재시험</b>에서만 올라요. 최종 목표는 전체 96%.
      </p>
