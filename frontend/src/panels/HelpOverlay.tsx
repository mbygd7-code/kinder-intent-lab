  ...
  return (
    <div className="help-doc">
      ...
      <p>
        ...
        말을 <b>평소 말투로</b> 쓰세요 (의도 id·뜻 칸은 🔒 그대로 두기). 다 채울 필요
        없어요 — 되는 만큼만.
      </p>
      <table className="help-table">
        <tbody>
          <tr>
            <td>🟢 좋아요</td>
            <td>"다온이 할머니가 데려가셔서 조퇴야" (출결 기록) — 평소 말투. '출결'이란
              단어가 없어도 뜻이 분명해요</td>
          </tr>
          <tr>
            <td>🟢 좋아요</td>
            <td>"이건 서준이네만 따로 알려야 할 것 같은데" (개별 학부모 메시지) — 헷갈리는
              이웃(학급 알림장)과 확실히 구별돼요</td>
          </tr>
          <tr>
            <td>🔴 아쉬워요</td>
            <td>"출결을 기록해줘" — 의도 이름을 그대로 읽은 문장. 현장에서 이렇게 말 안 해요</td>
          </tr>
          <tr>
            <td>🔴 아쉬워요</td>
            <td>강화하기·즉석 문답에서 봤던 문장 그대로 — 공부용과 겹치면 자동 거부돼요</td>
          </tr>
        </tbody>
      </table>
